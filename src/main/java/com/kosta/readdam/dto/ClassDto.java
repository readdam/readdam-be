...
public class ClassDto {
    ...
    public static ClassDto fromEntity(ClassEntity entity) {
        return ClassDto.builder()
                ...
                .leaderUsername(entity.getLeader().getUsername())
                ...
                .tag2(entity.getTag2())
                .tag3(entity.getTag3())
                .minPerson(entity.getMinPerson())
                .maxPerson(entity.getMaxPerson())
                .mainImg(entity.getMainImg())
                .classIntro(entity.getClassIntro())
                .leaderImg(entity.getLeaderImg())
                .leaderIntro(entity.getLeaderIntro())
                .isReaddam(entity.getIsReaddam())
                .round1Date(entity.getRound1Date())
                .round1PlaceName(entity.getRound1PlaceName())
                .round1PlaceLoc(entity.getRound1PlaceLoc())
                .round1Img(entity.getRound1Img())
                .round1Content(entity.getRound1Content())
                .round1Bookname(entity.getRound1Bookname())
                .round1Bookimg(entity.getRound1Bookimg())
                .round1Bookwriter(entity.getRound1Bookwriter())
                .round1Lat(entity.getRound1Lat())
                .round1Log(entity.getRound1Log())
                .round2Date(entity.getRound2Date())
                .round2PlaceName(entity.getRound2PlaceName())
                .round2PlaceLoc(entity.getRound2PlaceLoc())
                .round2Img(entity.getRound2Img())
                .round2Content(entity.getRound2Content())
                .round2Bookname(entity.getRound2Bookname())
                .round2Bookimg(entity.getRound2Bookimg())
                .round2Bookwriter(entity.getRound2Bookwriter())
                .round2Lat(entity.getRound2Lat())
                .round2Log(entity.getRound2Log())
                .round3Date(entity.getRound3Date())
                .round3PlaceName(entity.getRound3PlaceName())
                .round3PlaceLoc(entity.getRound3PlaceLoc())
                .round3Img(entity.getRound3Img())
                .round3Content(entity.getRound3Content())
                .round3Bookname(entity.getRound3Bookname())
                .round3Bookimg(entity.getRound3Bookimg())
                .round3Bookwriter(entity.getRound3Bookwriter())
                .round3Lat(entity.getRound3Lat())
                .round3Log(entity.getRound3Log())
                .round4Date(entity.getRound4Date())
                .round4PlaceName(entity.getRound4PlaceName())
                .round4PlaceLoc(entity.getRound4PlaceLoc())
                .round4Img(entity.getRound4Img())
                .round4Content(entity.getRound4Content())
                .round4Bookname(entity.getRound4Bookname())
                .round4Bookimg(entity.getRound4Bookimg())
